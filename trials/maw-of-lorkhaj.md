    ...
    <div id="timeline-descriptions-wrapper">
      ...
      <div class="section" data-description="seven">
        ...
        <ul>
          ...
          <li><b>Execute</b> - At 12% the boss will move to the centre large pad in the middle of the room, cease attacking and begin channeling/summoning.  During this phase the large pad will lose its colour and no longer apply a curse to players but all outside (smaller) pads will turn blue.  Shortly after he moves to the middle a blue orb will spawn on pad one (the first pad that turned gold) and link to the boss via a blue beam.  This orb increases the boss' resistances further but can be disrupted/removed if it is touched by a player.  Every few seconds an orb will spawn on a pad in this manner, starting from pad one moving clockwise each time.  All other mechanics (described below) will be ongoing during the execute phase.</li>
        </ul>
        <h3>Orb mechanics</h3>
        <p>There are three different attacks that start at different points in the fight but continue throughout:</p>
        <ul>
          ...
          <li><b>Tether Orbs</b> - From pad five small blue orbs will hover towards a player, link to them via a blue beam and follow them slowly.  The linked player will take continuous damage from the orb as well as anyone close to it.  Moving too far from the orb will break the tether but the orb will remain active; simply targeting another nearby player and tethering to them instead.</li>
          <li><b>Explosive Orbs</b> - A new, large AoE will start appearing from pad seven that will cause massive damage to anyone caught inside it.  It leaves behind an orb which will explode shortly after and deal a lot of damage to anyone too close to it.</li>
        </ul>
        <h2>Hardmode</h2>
        <p>There are a couple of changes when hardmode is activated but it does not drastically change the strategies used in this fight, everything hits a little harder and has more health of course.</p>
        <ul>
          <li><b>Curse</b> - There are now no active cleanse pads so players with the curse will not be able to remove it unless they are killed.  The cursed player will now cause damage to any other player they get too close to.  This appears as small, blue, orbs shooting from the cursed player to others.</li>
          <li><b>Assassins</b> - Everytime the players running the "Backyard" mechanic kill two of the Void Callers an Assassin will spawn in the main boss room.</li>
        </ul>
        <div class="spoiler">
          <input type="checkbox" class="spoiler-button">
          <div class="spoiler-head">Strategies</div>
