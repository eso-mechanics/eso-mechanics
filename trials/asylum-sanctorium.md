  ...
  <div class="input-flex-container">
    ...
    <div id="timeline-descriptions-wrapper">
      ...
      <div class="section" data-description="three">
        ...
        <p>Going right when facing the gate to the final boss will take you to Saint Felms.  This boss can get very messy, very quickly if some key mechanics are not dealt with properly.  This is mainly because he leaves lingering AoEs in the wake of some of his attacks which can leave you very little room left to work with if you are not careful.  Getting hit by any of his attacks will also apply Maim to the player causing their attacks to do less damage.</p>
        <ul>
